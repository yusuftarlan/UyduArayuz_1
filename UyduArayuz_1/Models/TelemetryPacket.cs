...
namespace UyduArayuz_1.Models
{
    public class TelemetryPacket
    {
        ...
        public string SatelliteStatusString { get; set; } // <UYDU STATÜSÜ Kelime>
        public int ErrorCode { get; set; }       // <HATA KODU> 
        public string ErrorCodeString { get; set; }       // <HATA KODU Kelime> 
        public string SentDate { get; set; }  // <GÖNDERME SAATİ> [cite: 367]
        ...
        public string TaskCode { get; set; }      // <RHRHRH> (Bonus Görev) [cite: 379]
