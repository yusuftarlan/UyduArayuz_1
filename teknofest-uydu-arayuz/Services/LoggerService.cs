...
namespace TeknofestUyduArayuz.Services
{
    ...
    public sealed class LoggerService : IApplicationLogger, IDisposable
    {
        ...
        public LoggerService(ApplicationLogRecorder? persistentRecorder = null)
        {
            ...
            // Seri port görevinden gelen loglar ile WPF binding erişimini aynı kilitte eşgüdümler.
        ...
        public void AddPersistentLog(string message, string level)
        {
            ...
            if (!IsWarnOrError(newLog.Level))
            {
                throw new ArgumentException(
                    "Kalıcı uygulama logları WARN veya ERROR seviyesini kullanmalıdır.",
                    nameof(level));
            }
        ...
        private void TryWriteToFile(LogModel log)
        {
            ...
            {
                Debug.WriteLine("Uygulama logu TXT kaydedici kuyruğuna eklenemedi.");
            }
        }
