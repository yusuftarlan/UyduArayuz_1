...
public sealed class TelemetryCsvRecorder : ITelemetryRecorder, IDisposable
{
    ...
    public bool TryRecord(TelemetryPacket packet)
    {
        ...
        // Seri okuma görevini disk I/O ile bloklamamak için dolu kuyrukta beklenmez;
        // TryWrite başarısızlığı üst katmana kayıt kaybı olarak bildirilir.
    ...
    private static string ToCsvRow(TelemetryPacket packet)
    {
        return string.Join(',',
            ...
            packet.SentDate.ToString("dd.MM.yyyy HH:mm:ss", CultureInfo.InvariantCulture),
