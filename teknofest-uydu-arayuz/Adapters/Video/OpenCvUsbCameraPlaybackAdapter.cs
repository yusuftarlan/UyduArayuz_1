...
namespace TeknofestUyduArayuz.Adapters.Video;

// Kamera yakalamayı UI thread'inden ayırır ve render kuyruğunda yalnız en yeni kareyi tutar.
internal sealed class OpenCvUsbCameraPlaybackAdapter : IAsyncDisposable
{
    ...
    public async Task StopAsync()
    {
        ...
        if (cancellation is not null)
        {
            ...
            {
                // StopAsync tarafından başlatılan iptal beklenen kapanış yoludur.
            }
            finally
            {
    ...
    private void PublishFrame(BitmapSource frame)
    {
        ...
        lock (_frameSync)
        {
            ...
            // Bekleyen kareyi yenisiyle değiştirmek, yavaş UI durumunda gecikme
            // oluşturan eski kare kuyruğunun büyümesini engeller.
            _pendingFrame = frame;
